...
export function buildServiceEnvironment(params: {
  ...
  const profile = env.SENDELL_PROFILE;
  ...
  return {
    ...
    SENDELL_PROFILE: profile,
    SENDELL_STATE_DIR: env.SENDELL_STATE_DIR,
    SENDELL_CONFIG_PATH: env.SENDELL_CONFIG_PATH,
    SENDELL_GATEWAY_PORT: String(port),
    SENDELL_GATEWAY_TOKEN: token,
    SENDELL_LAUNCHD_LABEL: resolvedLaunchdLabel,
    SENDELL_SYSTEMD_UNIT: systemdUnit,
    SENDELL_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    SENDELL_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    SENDELL_STATE_DIR: env.SENDELL_STATE_DIR,
    SENDELL_CONFIG_PATH: env.SENDELL_CONFIG_PATH,
    SENDELL_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    SENDELL_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    SENDELL_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    SENDELL_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    SENDELL_LOG_PREFIX: "node",
    SENDELL_SERVICE_MARKER: NODE_SERVICE_MARKER,
    SENDELL_SERVICE_KIND: NODE_SERVICE_KIND,
    SENDELL_SERVICE_VERSION: VERSION,
  };
}
