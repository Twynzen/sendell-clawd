...
export const DEFAULT_LOG_DIR = "/tmp/sendell";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "sendell.log"); // legacy single-file path

const LOG_PREFIX = "sendell";
...
function resolveSettings(): ResolvedSettings {
  let cfg: SendellConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => SendellConfig;
      };
