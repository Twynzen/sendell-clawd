...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SendellConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SendellConfig; env: NodeJS.ProcessEnv }): {
  cfg: SendellConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
