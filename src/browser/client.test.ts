...
describe("browser client", () => {
  ...
  it("adds Authorization when SENDELL_BROWSER_CONTROL_TOKEN is set", async () => {
    const prev = process.env.SENDELL_BROWSER_CONTROL_TOKEN;
    process.env.SENDELL_BROWSER_CONTROL_TOKEN = "t1";
    ...
    process.env.SENDELL_BROWSER_CONTROL_TOKEN = prev;
  });
