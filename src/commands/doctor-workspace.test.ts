...
describe("detectLegacyWorkspaceDirs", () => {
  it("ignores ~/sendell when it doesn't look like a workspace (e.g. install dir)", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/sendell";
    const candidate = path.join(home, "sendell");
  ...
  it("flags ~/sendell when it contains workspace markers", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/sendell";
    const candidate = path.join(home, "sendell");
