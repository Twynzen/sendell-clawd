...
export async function updateConfig(
  mutator: (cfg: SendellConfig) => SendellConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: SendellConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: SendellConfig): Set<string> {
