...
export function applyZaiConfig(cfg: SendellConfig): SendellConfig {
...
export function applyOpenrouterProviderConfig(cfg: SendellConfig): SendellConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: SendellConfig): SendellConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: SendellConfig): SendellConfig {
...
export function applyOpenrouterConfig(cfg: SendellConfig): SendellConfig {
...
export function applyMoonshotProviderConfig(cfg: SendellConfig): SendellConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: SendellConfig): SendellConfig {
...
export function applyKimiCodeProviderConfig(cfg: SendellConfig): SendellConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: SendellConfig): SendellConfig {
...
export function applySyntheticProviderConfig(cfg: SendellConfig): SendellConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: SendellConfig): SendellConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: SendellConfig): SendellConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: SendellConfig): SendellConfig {
