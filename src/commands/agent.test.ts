...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "sendell-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<SendellConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<SendellConfig["telegram"]>>,
