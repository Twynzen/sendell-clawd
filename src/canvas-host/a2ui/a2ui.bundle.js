...
var SendellA2UIHost = class extends i$6 {
	static properties = {
		surfaces: { state: true },
    ...
    :host {
      ...
      box-sizing: border-box;
      padding:
        var(--sendell-a2ui-inset-top, 0px)
        var(--sendell-a2ui-inset-right, 0px)
        var(--sendell-a2ui-inset-bottom, 0px)
        var(--sendell-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--sendell-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--sendell-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--sendell-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--sendell-a2ui-empty-top, var(--sendell-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  `;
	connectedCallback() {
		...
		globalThis.addEventListener("sendell:a2ui-action-status", this.#statusListener);
		this.#syncSurfaces();
	}
	disconnectedCallback() {
		super.disconnectedCallback();
		if (this.#statusListener) {
			globalThis.removeEventListener("sendell:a2ui-action-status", this.#statusListener);
	...
	#handleA2UIAction(evt) {
		...
		globalThis.__sendellLastA2UIAction = userAction;
		const handler = globalThis.webkit?.messageHandlers?.sendellCanvasA2UIAction ?? globalThis.sendellCanvasA2UIAction;
		if (handler?.postMessage) {
			try {
				if (handler === globalThis.sendellCanvasA2UIAction) {
...
customElements.define("sendell-a2ui-host", SendellA2UIHost);
