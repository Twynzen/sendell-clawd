...
export const A2UI_PATH = "/__sendell__/a2ui";
export const CANVAS_HOST_PATH = "/__sendell__/canvas";
export const CANVAS_WS_PATH = "/__sendell/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.sendellCanvasA2UIAction.postMessage(...)
  // - Android: window.sendellCanvasA2UIAction.postMessage(...)
  const actionHandlerName = "sendellCanvasA2UIAction";
  ...
  globalThis.Sendell = globalThis.Sendell ?? {};
  globalThis.Sendell.postMessage = postToNode;
  globalThis.Sendell.sendUserAction = sendUserAction;
  globalThis.sendellPostMessage = postToNode;
  globalThis.sendellSendUserAction = sendUserAction;
