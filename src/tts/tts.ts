...
export function resolveTtsConfig(cfg: SendellConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.SENDELL_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: SendellConfig): string | undefined {
