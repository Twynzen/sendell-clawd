...
function resolveAnthropicDefaultAuthMode(cfg: SendellConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: SendellConfig): SendellConfig {
...
export function applyTalkApiKey(config: SendellConfig): SendellConfig {
...
export function applyModelDefaults(cfg: SendellConfig): SendellConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SendellConfig): SendellConfig {
...
export function applyLoggingDefaults(cfg: SendellConfig): SendellConfig {
...
export function applyContextPruningDefaults(cfg: SendellConfig): SendellConfig {
...
export function applyCompactionDefaults(cfg: SendellConfig): SendellConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
