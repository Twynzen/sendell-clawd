// Scope compatibility utilities for enforcing caller-scope subsetting on
// device.token.rotate — prevents privilege escalation by ensuring tokens
// cannot be minted with broader scopes than the requesting session holds.
...
export function normalizeDeviceTokenScopes(scopes: string[] | undefined): string[] {
