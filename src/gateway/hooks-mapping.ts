...
import { CONFIG_PATH_SENDELL, type HookMappingConfig, type HooksConfig } from "../config/config.js";
...
export function resolveHookMappings(hooks?: HooksConfig): HookMappingResolved[] {
  ...
  const configDir = path.resolve(path.dirname(CONFIG_PATH_SENDELL));
...
// webhook payloads to prevent prototype pollution and data leakage.
