...
import { type SendellConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: SendellConfig): string[] {
...
export function listAgentsForGateway(cfg: SendellConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: SendellConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: SendellConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: SendellConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: SendellConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: SendellConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: SendellConfig): GatewaySessionsDefaults {
