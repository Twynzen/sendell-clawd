...
export function listChannelMessageActions(cfg: SendellConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: SendellConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: SendellConfig): boolean {
  for (const plugin of listChannelPlugins()) {
