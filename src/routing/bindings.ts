...
export function listBindings(cfg: SendellConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: SendellConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SendellConfig) {
