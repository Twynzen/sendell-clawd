...
function resolveAvatarSource(cfg: SendellConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SendellConfig, agentId: string): AgentAvatarResolution {
