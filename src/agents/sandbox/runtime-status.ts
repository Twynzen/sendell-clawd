...
function resolveMainSessionKeyForSandbox(params: { cfg?: SendellConfig; agentId: string }): string {
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`sendell sandbox explain --session ${runtime.sessionKey}`)}`,
  );
