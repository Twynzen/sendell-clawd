...
import { STATE_DIR_SENDELL } from "../../config/config.js";

export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".sendell", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "sendell-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "sendell-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "sendell-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "sendell-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "sendell-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR_SENDELL ?? path.join(os.homedir(), ".sendell");
