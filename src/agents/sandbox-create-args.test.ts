  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "sendell.sandbox=1",
        "--label",
        "sendell.sessionKey=main",
        "--label",
        "sendell.createdAtMs=1700000000000",
        "--label",
        "sendell.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
