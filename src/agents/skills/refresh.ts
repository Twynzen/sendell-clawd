...
function resolveWatchPaths(workspaceDir: string, config?: SendellConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: SendellConfig }) {
