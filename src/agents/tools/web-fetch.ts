...
type WebFetchConfig = NonNullable<SendellConfig["tools"]>["web"] extends infer Web
...
function resolveFetchConfig(cfg?: SendellConfig): WebFetchConfig {
...
async function runWebFetch(params: {
  ...
  try {
    ...
    if (params.firecrawlEnabled && params.firecrawlApiKey) {
      ...
      const wrapped = wrapWebContent(truncated.text, "web_fetch");
      const payload = {
        url: params.url,
