...
export const DEFAULT_MEMORY_FLUSH_PROMPT = [
  ...
  "Store durable memories now using memory_save (category: decision/discovery/pattern/bug/preference/note).",
  "Save a structured checkpoint: goal, key discoveries, files modified, and next steps.",
  `If nothing to store, reply with ${SILENT_REPLY_TOKEN}.`,
].join(" ");

export const DEFAULT_MEMORY_FLUSH_SYSTEM_PROMPT = [
  "Pre-compaction memory flush turn.",
  "The session is near auto-compaction; capture durable memories to disk via memory_save.",
  "Focus on: current goal, important decisions, discoveries, modified files, and unfinished work.",
...
export function resolveMemoryFlushSettings(cfg?: SendellConfig): MemoryFlushSettings | null {
