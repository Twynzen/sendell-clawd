...
function resolveMentionPatterns(cfg: SendellConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: SendellConfig | undefined, agentId?: string): RegExp[] {
