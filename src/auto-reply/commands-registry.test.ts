...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@sendell", { botUsername: "sendell" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@sendell args", {
        botUsername: "sendell",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "sendell" })).toBe(
      "/help@otherbot",
    );
  });
