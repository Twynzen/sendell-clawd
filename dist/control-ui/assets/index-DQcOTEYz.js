  ...
  `}function oh(e){const t=e.hello?.snapshot,n=t?.uptimeMs?io(t.uptimeMs):"n/a",s=t?.policy?.tickIntervalMs?`${t.policy.tickIntervalMs}ms`:"n/a",i=(()=>{if(e.connected||!e.lastError)return null;const o=e.lastError.toLowerCase();if(!(o.includes("unauthorized")||o.includes("connect failed")))return null;const l=!!e.settings.token.trim(),p=!!e.password.trim();return!l&&!p?r`
        <div class="muted" style="margin-top: 8px;">
          ...
          <div style="margin-top: 6px;">
            <span class="mono">sendell dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">sendell doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px;">
            <a
              class="session-link"
              href="https://docs.sendell.dev/web/dashboard"
              target="_blank"
              rel="noreferrer"
      ...
      <div class="muted" style="margin-top: 8px;">
        ...
        <span class="mono">sendell dashboard --no-open</span>, or update the token,
        then click Connect.
        <div style="margin-top: 6px;">
          <a
            class="session-link"
    ...
    `})(),a=(()=>{if(e.connected||!e.lastError||(typeof window<"u"?window.isSecureContext:!0)!==!1)return null;const c=e.lastError.toLowerCase();return!c.includes("secure context")&&!c.includes("device identity required")?null:r`
      <div class="muted" style="margin-top: 8px;">
        ...
        <div style="margin-top: 6px;">
          <a
            class="session-link"
            href="https://docs.sendell.dev/gateway/tailscale"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            class="session-link"
            href="https://docs.sendell.dev/web/control-ui#insecure-http"
            target="_blank"
            rel="noreferrer"
        ...
        <div class="form-grid" style="margin-top: 16px;">
          ...
          <label class="field">
            ...
            <input
              ...
              placeholder="SENDELL_GATEWAY_TOKEN"
            />
          </label>
          <label class="field">
        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            ...
            <div class="brand-text">
              <div class="brand-title">SENDELL</div>
