---
summary: "Use MiniMax M2.1 in Sendell"
read_when:
  - You want MiniMax models in Sendell
...
Configure manually via `sendell.json`:
...
- Use `sendell models list` and `sendell models set minimax/MiniMax-M2.1` to switch.
...
- Running `sendell configure` and selecting **MiniMax M2.1**, or
