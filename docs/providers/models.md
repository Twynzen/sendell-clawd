---
summary: "Model providers (LLMs) supported by Sendell"
read_when:
...
Sendell can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `sendell onboard`).
