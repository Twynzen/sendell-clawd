...
You can point Sendell at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Sendell
...
- [Anthropic provider](/providers/anthropic) - Native Sendell integration with Claude Code CLI OAuth
