---
summary: "Use Qwen OAuth (free tier) in Sendell"
read_when:
  - You want to use Qwen with Sendell
...
```bash
sendell models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Sendell will sync credentials
