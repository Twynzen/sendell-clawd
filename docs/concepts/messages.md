...
This page ties together how Sendell handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Sendell keeps a
...
Sendell separates the **prompt body** from the **command body**:
...
Sendell can expose or hide model reasoning:
