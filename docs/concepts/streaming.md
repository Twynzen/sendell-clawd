...
Sendell has two separate “streaming” layers:
...
When block streaming is enabled, Sendell can **merge consecutive block chunks**
...
When draft streaming is active, Sendell disables block streaming for that reply to avoid double-streaming.
