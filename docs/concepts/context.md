...
read_when:
  - You want to understand what “context” means in Sendell
  - You are debugging why the model “knows” something (or forgot it)
  - You want to reduce context overhead (/context, /status, /compact)
---
# Context

“Context” is **everything Sendell sends to the model for a run**. It is bounded by the model’s **context window** (token limit).

Beginner mental model:
- **System prompt** (Sendell-built): rules, tools, skills list, time/runtime, and injected workspace files.
...
## How Sendell builds the system prompt

The system prompt is **Sendell-owned** and rebuilt each run. It includes:
...
By default, Sendell injects a fixed set of workspace files (if present):
- `AGENTS.md`
- `SOUL.md`
- `TOOLS.md`
- `IDENTITY.md`
