...
read_when:
  - Installing Sendell on Windows
  - Looking for Windows companion app status
---
# Windows (WSL2)

Sendell on Windows is recommended **via WSL2** (Ubuntu recommended). The
