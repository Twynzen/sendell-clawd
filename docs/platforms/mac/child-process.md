...
service via the external `sendell` CLI (no embedded runtime). This gives you
...
- The app installs a per‑user LaunchAgent labeled `com.sendell.gateway`
