...
- Same path: run the app from a fixed location (for Sendell, `dist/Sendell.app`).
...
```bash
sudo tccutil reset Accessibility com.sendell.mac
sudo tccutil reset ScreenCapture com.sendell.mac
