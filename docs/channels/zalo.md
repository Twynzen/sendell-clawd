...
- Install via CLI: `sendell plugins install @sendell/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `sendell plugins install ./extensions/zalo`
   - From npm (if published): `sendell plugins install @sendell/zalo`
...
- Approve via:
  - `sendell pairing list zalo`
  - `sendell pairing approve zalo <CODE>`
...
- Example: `sendell message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `sendell channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `sendell logs --follow`
