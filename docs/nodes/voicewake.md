...
Sendell treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.sendell/settings/voicewake.json`

Shape:

```json
{ "triggers": ["sendell", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
