...
### Changes
- Version alignment with core Sendell release numbers.
...
### Highlights
- First public release of the @sendell/voice-call plugin.
...
- CLI: `sendell voicecall` commands (call/start/continue/speak/end/status/tail/expose).
