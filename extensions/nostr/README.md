...
Nostr DM channel plugin for Sendell using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Sendell. It enables your bot to:
...
# Configure sendell to use local relay
