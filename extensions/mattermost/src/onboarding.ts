import type { ChannelOnboardingAdapter, SendellConfig, WizardPrompter } from "sendell/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.sendell.bot/channels/mattermost",
    ].join("\n"),
