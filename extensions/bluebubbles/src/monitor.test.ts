...
import { removeAckReactionAfterReply, shouldAckReaction } from "sendell/plugin-sdk";
import type { SendellConfig, PluginRuntime } from "sendell/plugin-sdk";
import {
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/sendell") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
