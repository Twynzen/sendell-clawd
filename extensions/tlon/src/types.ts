...
export function resolveTlonAccount(cfg: SendellConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: SendellConfig): string[] {
  const base = cfg.channels?.tlon as
