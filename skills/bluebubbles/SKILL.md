---
name: bluebubbles
description: Build or update the BlueBubbles external channel plugin for Sendell (extension package, REST send/probe, webhook inbound).
---
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `sendell/plugin-sdk` helpers.
